...
import profilePic from '../assets/FaricProfile.jpg';
        ...
        <div className="flex flex-wrap">
            <div className="w-full lg:w-1/2">
                <div className="flex flex-col items-center lg:items-start">
                    ...
                    initial="hidden"
                    animate="visible"
                    className="pb-14 text-4xl font-thin tracking-tight lg:mt-16 lg:text-6xl">Faric Andrevano</motion.h1>
                    <motion.span
            ...
            <div className='w-full lg:w-1/2 lg:p-8'>
                <div className='flex lg:justify-end justify-center'>
                    ...
                    transition={{duration: 1,delay: 1.1}}
                     src={profilePic} alt="profile" className='w-1/2 rounded-xl' />
                </div>
            </div>
        </div>
    </div>
